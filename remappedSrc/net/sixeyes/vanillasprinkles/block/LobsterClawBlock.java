...
public class LobsterClawBlock extends AbstractPlantStemBlock {
    public static final MapCodec<LobsterClawBlock> CODEC = LobsterClawBlock.createCodec(LobsterClawBlock::new);
    protected static final VoxelShape SHAPE = Block.createCuboidShape(4.0, 9.0, 4.0, 12.0, 16.0, 12.0);

    private final double growthChance;

    public MapCodec<LobsterClawBlock> getCodec() {
        return CODEC;
    }
    ...
    public LobsterClawBlock(AbstractBlock.Settings settings) {
    ...
    protected Block getPlant() {
        return ModBlocks.LOBSTER_CLAW_PLANT;
    }
