...
public class ThickGrassBlock extends PlantBlock {
    ...
    public BlockState getPlacementState(ItemPlacementContext ctx) {
        ...
        return blockPos.getY() < world.getTopY(Heightmap.Type.WORLD_SURFACE, blockPos) - 2 && world.getBlockState(blockPos.up(2)).canReplace(ctx) ? super.getPlacementState(ctx) : null;
    }
